...
size_t FontEngineFT::getFontNameAndStyle(const char path[], char name[], size_t length, fem::FontStyle* style)
{
    FT_Library  library;
    size_t count = 0;
...
size_t FontEngineFT::getFontNameAndStyle(const void* buffer, const uint32_t bufferLength, char name[], size_t length, fem::FontStyle*  style)
{
    FT_Library  library;
    size_t count = 0;
